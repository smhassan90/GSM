...
import com.greenstar.mecwheel.crb.controller.MedIQ;
import com.greenstar.mecwheel.crb.controller.Menu;
import com.greenstar.mecwheel.crb.controller.SignUp;
...
public class MainActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        } else if (id == R.id.btnMedIQ) {
            SharedPreferences shared = getSharedPreferences(Codes.PREF_NAME, MODE_PRIVATE);
            String userId = (shared.getString("userId", ""));
            if(userId.equals("")){
                intent = new Intent(this, SignUp.class);
            }else{
                intent = new Intent(this, MedIQ.class);
            }
